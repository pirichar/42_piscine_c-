...
int main() {
    ...
    std::cout << "\n---------------------Trying PresidentialPardonForm---------------------" << std::endl;
    std::cout << bur3 << " is trying to sign " << form3 << std::endl;
    bur3.signForm(form3);
    std::cout << bur3 << " is trying to execute " << form3 << "---------------------" << std::endl;
    bur3.executeForm(form3);

    std::cout << "\n---------------------Trying to sign RobotoryForm---------------------" << std::endl;
    std::cout << bur3 << " is trying to sign " << form2 << std::endl;
    bur3.signForm(form2);
    std::cout << "\n---------------------Trying to execute #1 RobotoryForm---------------------" << std::endl;
    std::cout << bur3 << " is trying to execute " << form2 << "---------------------" << std::endl;
    bur3.executeForm(form2);
    std::cout << "\n---------------------Trying to execute #2 RobotoryForm---------------------" << std::endl;
    std::cout << bur3 << " is trying to execute " << form2 << "---------------------" << std::endl;
    bur3.executeForm(form2);
    std::cout << "\n---------------------Trying to execute #3 RobotoryForm---------------------" << std::endl;
    std::cout << bur3 << " is trying to execute " << form2 << "---------------------" << std::endl;
    bur3.executeForm(form2);
    std::cout << "\n---------------------Trying to execute #4 RobotoryForm---------------------" << std::endl;
    std::cout << bur3 << " is trying to execute " << form2 << "---------------------" << std::endl;
    bur3.executeForm(form2);
